...
public class UserEmailValidationTest {
    ...
    public UserEmailValidationTest(String emailTest, boolean expectedResult) {
    ...
    public void givenEmailSamples_WhenValid_ShouldReturnTrue() {
        try {
            boolean result = userRegistration.validateEmail(emailTest);
        } catch (UserRegistrationException e) {
            Assert.assertEquals(UserRegistrationException.ExceptionType.INVALID_EMAIL, e.type);
        }
    }
}
